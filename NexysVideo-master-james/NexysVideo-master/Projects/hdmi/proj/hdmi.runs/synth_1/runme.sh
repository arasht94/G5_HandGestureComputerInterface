...
HD_PWD='W:/ECE532/NexysVideo-master/Projects/hdmi/proj/hdmi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hdmi_wrapper.tcl
