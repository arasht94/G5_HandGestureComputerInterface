...
HD_PWD='W:/ECE532/NexysVideo-master/Projects/hdmi/proj/hdmi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source hdmi_wrapper.tcl -notrace
