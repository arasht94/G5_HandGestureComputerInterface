...
#include "intc/intc.h"
//#include <stdio.h>
#include "../../videodemo_bsp/microblaze_0/include/xuartlite_l.h"
//#include "xuartps.h"
#include "math.h"
#include <ctype.h>
#include <stdlib.h>
#include "../../videodemo_bsp/microblaze_0/include/xil_types.h"
#include "../../videodemo_bsp/microblaze_0/include/xil_cache.h"
#include "../../videodemo_bsp/microblaze_0/include/xparameters.h"
...
void DemoInitialize()
{
	...
	if (Status != XST_SUCCESS)
	{
		printf("Video Ctrl initialization failed during demo initialization%d\r\n", Status);
		return;
	}
...
void DemoPrintMenu()
{
	...
	printf("**************************************************\n\r");
	printf("*                ZYBO Video Demo                 *\n\r");
	printf("**************************************************\n\r");
	printf("*Display Resolution: %28s*\n\r", dispCtrl.vMode.label);
	//printf("*Display Pixel Clock Freq. (MHz): %15.3f*\n\r", dispCtrl.pxlFreq);
	printf("*Display Frame Index: %27d*\n\r", dispCtrl.curFrame);
	if (videoCapt.state == VIDEO_DISCONNECTED) printf("*Video Capture Resolution: %22s*\n\r", "!HDMI UNPLUGGED!");
	else printf("*Video Capture Resolution: %17dx%-4d*\n\r", videoCapt.timing.HActiveVideo, videoCapt.timing.VActiveVideo);
	printf("*Video Frame Index: %29d*\n\r", videoCapt.curFrame);
	printf("**************************************************\n\r");
	printf("\n\r");
	printf("1 - Change Display Resolution\n\r");
	printf("2 - Change Display Framebuffer Index\n\r");
	printf("3 - Print Blended Test Pattern to Display Framebuffer\n\r");
	printf("4 - Print Color Bar Test Pattern to Display Framebuffer\n\r");
	printf("5 - Start/Stop Video stream into Video Framebuffer\n\r");
	printf("6 - Change Video Framebuffer Index\n\r");
	printf("7 - Grab Video Frame and invert colors\n\r");
	printf("8 - Grab Video Frame and scale to Display resolution\n\r");
	printf("q - Quit\n\r");
	printf("\n\r");
	printf("\n\r");
...
void DemoCRMenu()
{
	...
	printf("q - Quit (don't change resolution)\n\r");
	printf("\n\r");
	printf("Select a new resolution:");
}
