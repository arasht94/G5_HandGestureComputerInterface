...
#gpio out, connects to JA pins
#set_property -dict {PACKAGE_PIN AB22 IOSTANDARD LVCMOS33} [get_ports gpio_io_o[0]]
#set_property -dict {PACKAGE_PIN AB21 IOSTANDARD LVCMOS33} [get_ports gpio_io_o[1]]
#set_property -dict {PACKAGE_PIN AB20 IOSTANDARD LVCMOS33} [get_ports gpio_io_o[2]]
#set_property -dict {PACKAGE_PIN AB18 IOSTANDARD LVCMOS33} [get_ports gpio_io_o[3]]
#set_property -dict {PACKAGE_PIN Y21 IOSTANDARD LVCMOS33} [get_ports gpio_io_o[4]]
#set_property -dict {PACKAGE_PIN AA21 IOSTANDARD LVCMOS33} [get_ports gpio_io_o[5]]
#connect gpio to led for debugging
...
set_property -dict {PACKAGE_PIN Y21 IOSTANDARD LVCMOS33} [get_ports {gpio_io_o[4]}]
set_property -dict {PACKAGE_PIN AA21 IOSTANDARD LVCMOS33} [get_ports {gpio_io_o[5]}]
set_property -dict {PACKAGE_PIN AA20 IOSTANDARD LVCMOS33} [get_ports gpio2_io_i]
