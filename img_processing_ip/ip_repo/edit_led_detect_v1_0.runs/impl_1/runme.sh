...
HD_PWD='W:/ece532/img_processing_ip/ip_repo/edit_led_detect_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_detect_v1_0.vdi -applog -m64 -messageDb vivado.pb -mode batch -source led_detect_v1_0.tcl -notrace
