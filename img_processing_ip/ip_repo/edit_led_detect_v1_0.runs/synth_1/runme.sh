...
HD_PWD='W:/ece532/img_processing_ip/ip_repo/edit_led_detect_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_detect_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source led_detect_v1_0.tcl
